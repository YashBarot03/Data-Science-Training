...
df = pd.concat([pd.read_csv("C:/Users/JAY MATAJI/OneDrive/Desktop/Datascience intern/Chicago_Crimes_2001_to_2004.csv, error_bad_lines=False), pd.read_csv('C:/Users/JAY MATAJI/OneDrive/Desktop/Datascience intern/Chicago_Crimes_2005_to_2007.csv", error_bad_lines=False)], ignore_index=True)
df= pd.concat([df, pd.read_csv("C:/Users/JAY MATAJI/OneDrive/Desktop/Datascience intern/Chicago_Crimes_2008_to_2011.csv", error_bad_lines=False)], ignore_index=True)
df= pd.concat([df, pd.read_csv("C:/Users/JAY MATAJI/OneDrive/Desktop/Datascience intern/Chicago_Crimes_2012_to_2017.csv", error_bad_lines=False)], ignore_index=True)
df.head()

df = df.sample(n=100000)
print(df.shape)
df.drop(['Unnamed: 0','ID','Description','Location Description','Date','Block','Location','FBI Code','Case Number','X Coordinate','Y Coordinate','Community Area','Updated On','IUCR'], inplace=True, axis=1)
nan_value = float("NaN")
