...
###  ANS   ###
# "C:\Program Files\Python39\python.exe" "C:/Users/JAY MATAJI/Downloads/titanic.py"
# C:\Users\JAY MATAJI\AppData\Roaming\Python\Python39\site-packages\seaborn\_decorators.py:36: FutureWarning: Pass the following variable as a keyword arg: x. From version 0.12, the only valid positional argument will be `data`, and passing other arguments without an explicit keyword will result in an error or misinterpretation.
#   warnings.warn(
...
#
# [8 rows x 8 columns]
# [0.00729397 0.93098636 0.01210765 0.01063351 0.01593306 0.01555875
#  0.0074867 ]
#   Features        Score
# 0      Sex   152.000000
# 1    SibSp     7.487395
